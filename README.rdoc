...
* fread:scaffold: generates a controller and optional model/migration just as above, but reads parameters for the Model from a file, rather than stdin.
...
<b>How do you use fread:scaffold?</b>

You'll need a list of parameters in a file, linefeed separated, like the following:
...
Then, run the generator like this:
  ...
  rails g fread:scaffold post /path/to/parameters.file index new edit 
